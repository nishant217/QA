...
function createSlot2(ownerName) {
  ...
  const Slot22 = React8.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime4.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function useSize(element) {
  const [size4, setSize] = React19.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React27.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime14.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React27.isValidElement(newElement) ? React27.cloneElement(newElement, void 0, newChildren) : null });
    }
